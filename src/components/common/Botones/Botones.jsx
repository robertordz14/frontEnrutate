...
const Botones = () => {
  ...
  return (
      <div className="containerBotones">
        <a href="https://www.enrutate.info/" target="_blank">
          <img src={imgCamion} alt="" className="camion" />
        </a>
        <a href="https://play.google.com/store/apps/details?id=com.esoftmovil.enrutate&hl=es_419" target="_blank">
          <img src={imgPlayStore} alt=""className="playStore" />
        </a>
        <a href="https://apps.apple.com/mx/app/enrutate/id1087679011?l=es&ls=1" target="_blank">
